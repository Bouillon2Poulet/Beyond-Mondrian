...
void createLevel1(Scene* scene)
{
    ...
    tabCube[0] = createCube(12, -10, 30, 3, 1, 0, 0, 0);
    ...
    //Elements du jeu
    tabCube[10] = createCube(8, -7.5, 2, 2, 1, 0, 0, 0);
    tabCube[11] = createCube(10.5, -5, 2, 2, 1, 0, 0, 0);
    tabCube[12] = createCube(11.5, -7.5, 2, 3, 1, 0, 0, 0);

    tabCube[13] = createCube(13, 1, 2, 0.2, 1, 0, 0, 0);
    tabCube[14] = createCube(15, 3, 2, 0.2, 1, 0, 0, 0);
    tabCube[15] = createCube(21, 7, 2, 0.2, 1, 0, 0, 0);
